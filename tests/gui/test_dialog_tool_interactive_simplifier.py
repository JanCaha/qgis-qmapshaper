...
from qgis.PyQt.QtWidgets import (QSlider, QSpinBox, QDialogButtonBox, QComboBox, QCheckBox)
...
def test_elements(data_layer: QgsVectorLayer, qgis_canvas: QgsMapCanvas, qgis_iface: QgisInterface,
    ...
    assert isinstance(dialog.modify_only_part, QCheckBox)
    assert isinstance(dialog.modify_selection, QComboBox)
...
def test_usage(data_layer: QgsVectorLayer, qgis_iface: QgisInterface, qgis_parent,
    ...
    with qtbot.waitSignal(dialog.data_generalized):
